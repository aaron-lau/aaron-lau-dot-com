    ...
    <main className="portfolio">
      <section className="hero">
        ...
        <h2 className="hero__sub-heading">
          I’m a <Link to="/uses/">software engineer</Link> currently working in New York City at <a href="https://datadoghq.com">Datadog</a>
        </h2>
        <section className="hero__social">
          ...
          <a href="https://twitter.com/aaron_lau">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <title>Twitter</title>
